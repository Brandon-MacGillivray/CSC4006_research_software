...
\textbf{Explanation:} The input is a resized RGB hand image, and most computation is shared before the network splits into heatmap and coordinate regression paths.
