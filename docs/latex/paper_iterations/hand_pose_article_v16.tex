...
\centering
\footnotesize
\caption{Transfer-learning results for the four training sequences evaluated on both RHD and HK26K, using fusion-mode evaluation.}
\label{tab:transfer_learning}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lcccccc}
\toprule
Training sequence & RHD SSE & RHD EPE & RHD PCK & HK26K SSE & HK26K EPE & HK26K PCK \\
\midrule
RHD-only & \textbf{0.3091 $\pm$ 0.0269} & \textbf{0.0764 $\pm$ 0.0030} & \textbf{0.9143 $\pm$ 0.0097} & 3.7488 $\pm$ 0.7985 & 0.3365 $\pm$ 0.0075 & 0.3719 $\pm$ 0.0434 \\
HK26K-only & 1.4194 $\pm$ 0.2619 & 0.1609 $\pm$ 0.0207 & 0.3397 $\pm$ 0.0718 & \textbf{0.0764 $\pm$ 0.0016} & \textbf{0.0612 $\pm$ 0.0049} & 0.9834 $\pm$ 0.0007 \\
HK26K $\rightarrow$ RHD & 0.4504 $\pm$ 0.0162 & 0.1020 $\pm$ 0.0039 & 0.8190 $\pm$ 0.0114 & 1.6426 $\pm$ 0.2293 & 0.2678 $\pm$ 0.0114 & 0.5320 $\pm$ 0.0164 \\
RHD $\rightarrow$ HK26K & 0.5699 $\pm$ 0.0592 & 0.1276 $\pm$ 0.0149 & 0.7690 $\pm$ 0.0221 & 0.0980 $\pm$ 0.0064 & 0.0840 $\pm$ 0.0018 & \textbf{0.9837 $\pm$ 0.0007} \\
\bottomrule
\end{tabular}
}
\end{table}
