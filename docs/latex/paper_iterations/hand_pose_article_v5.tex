...
\textbf{Evidence:} In Table~\ref{tab:mediapipe_baseline}, MediaPipe evaluated with \texttt{--hand auto} still gives much worse SSE and PCK than the learned models in both native-21 and shared-10 comparisons, despite achieving a detection success rate of 0.8933.
\textbf{Explanation:} This indicates that the learned pipeline remains substantially stronger on the benchmark dataset even after removing the earlier handedness-selection mismatch from the baseline evaluation.
